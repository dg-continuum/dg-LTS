...
import kr.syeyoung.dungeonsguide.oneconfig.huds.epicCountdownPage;
...
public class FeatureEpicCountdown extends SimpleFeatureV2 {
    ...
    public static ChatProcessResult processChat(String txt, Map<String, Object> context) {
        if(epicCountdownPage.cleanChat){
    ...
    public void onTick(TickEvent.ClientTickEvent e){
        if(e.phase != TickEvent.Phase.START || !epicCountdownPage.epicCountdown || !SkyblockStatus.isOnDungeon()) return;
...
//                   10/22/22 m65G 28266§r
    ...
    public void onRender(RenderGameOverlayEvent.Post postRender) {
        if (!epicCountdownPage.epicCountdown) return;

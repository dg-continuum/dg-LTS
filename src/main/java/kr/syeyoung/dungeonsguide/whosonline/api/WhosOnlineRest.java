...
import kr.syeyoung.dungeonsguide.whosonline.api.data.CosmeticData;
import kr.syeyoung.dungeonsguide.whosonline.api.data.CosmeticsUserPerms;
import lombok.val;
...
public class WhosOnlineRest {
    ...
    public void fillCosmeticCache(){
        ex.submit(() -> {
            ...
            ArrayList<kr.syeyoung.dungeonsguide.whosonline.api.data.CosmeticData> cms = new ArrayList<>();
            ...
            for (val element : c) {
                ...
                cms.add(new kr.syeyoung.dungeonsguide.whosonline.api.data.CosmeticData(id, displ, dscr, name, reqfgls));

...
public class MapUtils {
    ...
    public static Vector2i findFirstColorWithIn(byte[] colors, byte color, Rectangle dimension) {
        boolean found = true;
    ...
    public static Vector2i findFirstColorWithInNegate(byte[] colors, byte color, Rectangle dimension) {
        for (int y = dimension.y; y < (dimension.y + dimension.height);y++) {
            for (int x = dimension.x; x < (dimension.x + dimension.width); x ++) {
    ...
    public static int getWidthOfColorAt(byte[] colors, byte color, Vector2i point) {
    ...
    public static int getHeightOfColorAt(byte[] colors, byte color, Vector2i point) {
    ...
    public static int getLengthOfColorExtending(byte[] colors, byte color, Vector2i basePoint, Vector2i vector2d) {
        for (int i = 0; i < 128; i++) {

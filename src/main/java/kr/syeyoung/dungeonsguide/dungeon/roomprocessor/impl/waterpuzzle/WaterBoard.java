...
package kr.syeyoung.dungeonsguide.dungeon.roomprocessor.impl.waterpuzzle;

import kr.syeyoung.dungeonsguide.DungeonsGuide;
import kr.syeyoung.dungeonsguide.dungeon.data.OffsetPoint;
import kr.syeyoung.dungeonsguide.dungeon.data.OffsetPointSet;
import kr.syeyoung.dungeonsguide.dungeon.roomprocessor.impl.waterpuzzle.nodes.*;
        ...
        while (!toGoDownTo.isEmpty()) {
            ...
            if (asd.isWaterFilled(w) && (
                ...
                for (int i = asd.getX(); i < asd.getX() + 8; i++) {
                    ...
                    if (nodehere.getCondition() != null && leverStates.contains(nodehere.getCondition().invert()) && nodehere.isWaterFilled(w))
                        waterBlockingStates.add(nodehere.getCondition().invert());
